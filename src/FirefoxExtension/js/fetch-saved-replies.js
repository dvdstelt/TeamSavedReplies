// Classic-script copy of js/modules/fetch-saved-replies.js. Firefox's background
// is a page rather than a worker, so it parses the fetched markup itself and
// loads its scripts classically alongside the rest.
