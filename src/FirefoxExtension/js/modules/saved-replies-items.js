...
const filterVisibleSavedReplies = (text) => {
    ...
    console.log("filterVisibleSavedReplies called", text);

    const savedReplyElements =
      document.querySelectorAll(`div[data-saved-replies-name]`);
    
    for(let savedReplyElement of savedReplyElements){
...
export {copySavedReplyTemplate, toggleTemplateVisibility, onfilterVisibleSavedReplies, clearSearch};